...
SEED_APPLICATIONS = [
    {"app_id": "CRM", "name": "Customer Relationship Manager", "app_distributed_id": "AD-1001",
     "owner": "Team Eta", "nh": "NH02,NH14", "sz": "CCS(sz04),CDE(sz05),PAA(SZ02)", "criticality": "High", "pci_scope": True,
     "neighborhoods": "NH02,NH14", "szs": "CCS(sz04),CDE(sz05),PAA(SZ02)", "dcs": "ALPHA_NGDC,BETA_NGDC", "snow_sysid": "SYSID-CRM-001",
    ...
    {"app_id": "HRM", "name": "Human Resource Manager", "app_distributed_id": "AD-1002",
     "owner": "Team Platform", "nh": "NH01", "sz": "GEN(SZ01)", "criticality": "Medium", "pci_scope": False,
     "neighborhoods": "NH01", "szs": "GEN(SZ01)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-HRM-002",
    ...
    {"app_id": "TRD", "name": "Trading Platform", "app_distributed_id": "AD-1003",
     "owner": "Team Xi", "nh": "NH06,NH14", "sz": "CCS(sz04),CDE(sz05),PAA(SZ02)", "criticality": "Critical", "pci_scope": True,
     "neighborhoods": "NH06,NH14", "szs": "CCS(sz04),CDE(sz05),PAA(SZ02)", "dcs": "ALPHA_NGDC,BETA_NGDC,GAMMA_NGDC", "snow_sysid": "SYSID-TRD-003",
    ...
    {"app_id": "PAY", "name": "Payment Gateway", "app_distributed_id": "AD-1004",
     "owner": "Team Epsilon", "nh": "NH07", "sz": "CDE(sz05),CPA(sz06)", "criticality": "Critical", "pci_scope": True,
     "neighborhoods": "NH07", "szs": "CDE(sz05),CPA(sz06)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-PAY-004",
    ...
    {"app_id": "INS", "name": "Insurance Portal", "app_distributed_id": "AD-1005",
     "owner": "Team Kappa", "nh": "NH04", "sz": "CCS(sz04),GEN(SZ01)", "criticality": "High", "pci_scope": False,
     "neighborhoods": "NH04", "szs": "CCS(sz04),GEN(SZ01)", "dcs": "ALPHA_NGDC,BETA_NGDC", "snow_sysid": "SYSID-INS-005",
     "components": ["WEB", "APP", "DB", "BAT"],
     "description": "Insurance policy management"},
    {"app_id": "KYC", "name": "KYC Compliance", "app_distributed_id": "AD-1006",
     "owner": "Team Lambda", "nh": "NH05", "sz": "CCS(sz04),GEN(SZ01)", "criticality": "High", "pci_scope": False,
     "neighborhoods": "NH05", "szs": "CCS(sz04),GEN(SZ01)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-KYC-006",
    ...
    {"app_id": "FRD", "name": "Fraud Detection", "app_distributed_id": "AD-1007",
     "owner": "Team Eta", "nh": "NH02", "sz": "CCS(sz04),CDE(sz05)", "criticality": "Critical", "pci_scope": True,
     "neighborhoods": "NH02", "szs": "CCS(sz04),CDE(sz05)", "dcs": "ALPHA_NGDC,BETA_NGDC", "snow_sysid": "SYSID-FRD-007",
     "components": ["APP", "DB", "MQ", "API"],
     "description": "Real-time fraud detection engine"},
    {"app_id": "LND", "name": "Lending Platform", "app_distributed_id": "AD-1008",
     "owner": "Team Iota", "nh": "NH09", "sz": "CCS(sz04),GEN(SZ01)", "criticality": "High", "pci_scope": False,
     "neighborhoods": "NH09", "szs": "CCS(sz04),GEN(SZ01)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-LND-008",
     "components": ["WEB", "APP", "DB", "BAT"],
     "description": "Digital lending and loan origination"},
    {"app_id": "WLT", "name": "Wealth Management", "app_distributed_id": "AD-1009",
     "owner": "Team Mu", "nh": "NH10,NH14", "sz": "CDE(sz05),GEN(SZ01),PAA(SZ02)", "criticality": "High", "pci_scope": True,
     "neighborhoods": "NH10,NH14", "szs": "CDE(sz05),GEN(SZ01),PAA(SZ02)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-WLT-009",
     "components": ["WEB", "APP", "DB", "API"],
     "description": "Portfolio and wealth management"},
    {"app_id": "CBK", "name": "Core Banking", "app_distributed_id": "AD-1010",
     "owner": "Team Theta", "nh": "NH08", "sz": "CCS(sz04),CDE(sz05)", "criticality": "Critical", "pci_scope": True,
     "neighborhoods": "NH08", "szs": "CCS(sz04),CDE(sz05)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-CBK-010",
    ...
    {"app_id": "EPT", "name": "Enterprise Portal", "app_distributed_id": "AD-1011",
     "owner": "Team Platform", "nh": "NH01,NH14", "sz": "CCS(sz04),PAA(SZ02)", "criticality": "High", "pci_scope": False,
     "neighborhoods": "NH01,NH14", "szs": "CCS(sz04),PAA(SZ02)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-EPT-011",
    ...
    {"app_id": "MBK", "name": "Mobile Banking", "app_distributed_id": "AD-1012",
     "owner": "Team Epsilon", "nh": "NH07,NH14", "sz": "CPA(sz06),PAA(SZ02)", "criticality": "Critical", "pci_scope": True,
     "neighborhoods": "NH07,NH14", "szs": "CPA(sz06),PAA(SZ02)", "dcs": "ALPHA_NGDC", "snow_sysid": "SYSID-MBK-012",
     "components": ["WEB", "APP", "DB", "API"],
