        ...
        <div className="bg-white border rounded-lg shadow-sm p-4">
          <div className="mb-3 p-3 bg-rose-50 border border-rose-200 rounded-lg flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs rounded font-medium bg-gray-200 text-gray-700 hover:bg-gray-300"
            >
              Back to Rules
            </button>
          </div>
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-xs text-blue-700">
            View all requests and their history in the <a href="/firewall-studio/requests" className="underline font-medium">Request History</a> tab.
          </div>
        </div>
      ) : (
